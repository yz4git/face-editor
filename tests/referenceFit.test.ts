...
describe('sample-derived polygon geometry',()=>{
  it('keeps all ten hairstyles aligned to high-IoU source-sheet geometry',()=>{
    expect(GENERATED_VARIATION_SOURCE.hairCount).toBe(10);expect(GENERATED_VARIATION_SOURCE.fitRevision).toBe(8);expect(Object.keys(HAIR_PARTS)).toHaveLength(10);
  ...
  it('reconstructs all ten eyes from source-sheet contour coordinates',()=>{

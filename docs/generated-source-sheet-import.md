# Generated source-sheet import — revision 1

This import is the first production use of the generated-part-sheet workflow after Part Vectorizer v2 was added.
...
| `outfits.png` | `ede76806bd5d5c896d64d0ef96a138c8532ee86ba55b3c9688944b914b95ce9f` | 147516 | first row, 6 variants |

## Conversion

1. Split the sheet into deterministic cells.
2. Estimate the pale authoring background and build semantic flat-color masks.
3. Classify hair/accent, eye outline/sclera/iris/pupil/highlight, skin/outline, brow, mouth/tongue/outline and outfit jacket/shirt/hood/accent roles.
...
- Mouths: 10 / 594
- Outfits: 6 / 852
- Total: **66 selectable generated-source parts / 6581 source-derived triangles**

The character compiler adds only small structural underlays (neck skin, hair scalp cap and garment fill) to avoid visual gaps caused by independent generated sheets. The visible feature shapes and facets remain source-derived polygon data.

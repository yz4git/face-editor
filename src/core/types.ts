...
export type OutfitStyleId = 'hooded' | 'high-collar' | 'zip-collar' | 'drawstring' | 'short-sleeve' | 'vest' | 'blazer' | 'bomber' | 'long-coat' | 'tactical-jacket' | 'cropped-jacket' | 'tech-parka';
export type HoodStyleId = 'folded' | 'drawstring' | 'sharp' | 'high' | 'wide' | 'wing' | 'open-collar' | 'stand-collar' | 'fur-collar' | 'double-collar' | 'high-wrap' | 'split-lapel';
export type ShirtStyleId = 'tee' | 'long-sleeve' | 'tank' | 'three-quarter' | 'turtleneck' | 'sleeveless-high' | 'dress-shirt' | 'henley' | 'sweater' | 'hoodie-inner' | 'vest-inner' | 'utility-top';
export type StrapStyleId = 'simple' | 'padded' | 'single-pouch' | 'double-pouch' | 'cross' | 'y-harness' | 'chest-rig' | 'shoulder-brace' | 'belt-pack' | 'asymmetric-strap' | 'tech-harness' | 'layered-pouch';
export type AccentStyleId = 'diamond' | 'long-strip' | 'point-strip' | 'corner' | 'chevron' | 'slash' | 'taper' | 'triangle' | 'panel-line' | 'arm-band' | 'badge' | 'zip-line' | 'belt-buckle' | 'tech-emblem';

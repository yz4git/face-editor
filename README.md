...
The audit covers every cross-family value pair, rotates through real full-editor screenshots, and checks an iPhone-landscape viewport. Exhaustive checking is dynamically imported only in audit mode; normal editor sessions keep the lightweight rendering path. Work is checkpointed after every logical refinement. See [`docs/auto-fit-audit.md`](docs/auto-fit-audit.md).
